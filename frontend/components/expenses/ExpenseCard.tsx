...
// A single personal-expense ledger row following the strict
// content hierarchy from Section 3.5 of frontend_spec.md.

import type { ExpensePublic, ExpenseCategory } from "@/lib/types";
...
export const ExpenseCard = ({ expense }: ExpenseCardProps) => {
  return (
    <div className="flex items-center gap-3 p-4 bg-bg-surface rounded-2xl border border-border-subtle">
      {/* Category icon chip */}
      <div className="size-10 rounded-full bg-forest-tint flex items-center justify-center shrink-0 text-forest">
      ...
      {/* Amount in PKR */}
      <span className="text-lg font-semibold shrink-0 text-ink tabular-nums">
